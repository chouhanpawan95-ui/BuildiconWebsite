  ...
  <div className="row g-5 align-items-center mb-5">
    ...
    <div className="col-lg-6">
      <h1 className="display-1 mb-4 animated slideInRight">
        We Make Your <span className="text-primary">Software</span> Smarter
      </h1>
    ...
    <div className="col-lg-6 text-center">
      <div className="animated fadeIn">
        <img
          ...
          className="img-fluid rounded-circle border border-3 border-primary shadow-lg"
  ...
  <div className="row g-5 animated fadeIn">
    <div className="col-md-6 col-lg-3">
      <div className="d-flex align-items-center">
        ...
        <h5 className="lh-base mb-0">Crafted Software</h5>
      </div>
    </div>
    ...
    <div className="col-md-6 col-lg-3">
      <div className="d-flex align-items-center">
        ...
        <h5 className="lh-base mb-0">Sustainable Code</h5>
      </div>
    </div>
    ...
    <div className="col-md-6 col-lg-3">
      <div className="d-flex align-items-center">
        <div className="flex-shrink-0 btn-square border border-2 border-white me-3">
          <i className="fa fa-lightbulb text-primary"></i>
        </div>
    ...
    <div className="col-md-6 col-lg-3">
      <div className="d-flex align-items-center">
        <div className="flex-shrink-0 btn-square border border-2 border-white me-3">
          <i className="fa fa-wallet text-primary"></i>
        </div>
                    ...
                    <div className="p-5">
                        ...
                        <div className="position-relative w-100 mb-2">
                            <input className="form-control border-0 w-100 ps-4 pe-5" type="text"
                                placeholder="Enter Your Email" style={{height: 60}}/>
            ...
            <div className="row g-5">
                    ...
                    <div className="row">
                        ...
                        <div className="col-6 wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <div className="h-25 d-flex align-items-center text-center bg-primary px-4">
                                <h4 className="text-white lh-base mb-0">An Award-Winning Software Company Since 1990</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 className="mb-5"><span className="text-uppercase text-primary bg-light px-2">History</span> of Our
                        Creation</h1>
                    <p className="mb-4">Founded by a team of passionate developers and technology enthusiasts, BuildIcon started as a small software development unit focused on web and desktop applications.
With dedication, technical expertise, and a strong belief in quality</p>
                    <p className="mb-5">, we quickly grew into a trusted IT partner for clients across industries.</p>
